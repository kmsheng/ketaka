...
echo "Stored in: ". "/usr/local/Cellar/nginx/1.6.2/nginx/html/ketaka2015/".$_POST['folder']."/".$_POST['number'].".jpg";}
...
echo "Stored in: ". "/usr/local/Cellar/nginx/1.6.2/nginx/html/ketaka2015/".$_POST['folder']."/".$_FILES["upload"]["name"].".jpg";}
}
?>